<template>
    <div class="bg-white shadow-sm rounded-lg border border-slate-200 p-4 mb-6">
      ...
      <div v-if="isAdmin" class="mb-4">
        <div class="relative">
          ...
          <input
            v-model="searchQuery"
            type="text"
            placeholder="Cari berdasarkan nama perusahaan, alamat, atau nomor SLO..."
      ...
      <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-end gap-4">
          ...
          <!-- Filter Tipe -->
          <div>
            <label for="type-filter" class="block text-sm font-medium text-slate-700 mb-1">Tipe SLO</label>
            <select
              id="type-filter"
  ...
  const statusOptions = [
    ...
    { value: 'FIELD_VERIFICATION_SCHEDULED', label: 'Verifikasi Dijadwalkan' },
    { value: 'FIELD_VERIFICATION_COMPLETED', label: 'Verifikasi Selesai' },
    ...
    { value: 'SLO_ISSUED', label: 'SLO Diterbitkan' },
